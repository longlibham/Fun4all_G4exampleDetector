...
G4Example03DisplayAction::G4Example03DisplayAction(const std::string &name, PHParameters *pars)
...
void G4Example03DisplayAction::SetColor(const double red, const double green, const double blue, const double alpha)
{
